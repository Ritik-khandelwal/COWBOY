...
const Hero = () => {
  return (
    <>
        <div className='lg:flex px-[1rem] pt-[3rem] sm:px-[1.5rem] sm:pt-[1rem] md:px-[2.5rem] md:pt-[1rem]'>
            ...
            <div className='w-full h-auto flex justify-center lg:justify-end items-end pt-[3rem] lg:pt-[10rem]'>
